...
const styles = StyleSheet.create({
  ...
  imageWrapper: { alignItems: 'center', marginTop: 8, marginBottom: 8 },
  image: { width: 220, height: 220, borderRadius: 20, marginBottom: 8 },
  caption: { backgroundColor: '#222', color: '#fff', borderRadius: 18, paddingHorizontal: 16, paddingVertical: 10, fontSize: 16, width: 220, position: 'absolute', bottom: 10 },
  friendsList: { paddingHorizontal: 10, paddingVertical: 10 },
  friend: { alignItems: 'center', marginHorizontal: 8 },
  friendSelected: { borderColor: '#FFB800', borderWidth: 2, borderRadius: 30 },
  friendAvatar: { width: 56, height: 56, borderRadius: 28, marginBottom: 4 },
  friendName: { color: '#fff', fontSize: 14, marginTop: 2 },
  friendNameSelected: { color: '#FFB800', fontWeight: 'bold' },
  sendButton: { backgroundColor: '#FFB800', borderRadius: 32, padding: 18, alignItems: 'center', justifyContent: 'center', position: 'absolute', bottom: 30, right: 30, elevation: 3 },
});
